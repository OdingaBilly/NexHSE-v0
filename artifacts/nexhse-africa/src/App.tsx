...
function Navbar() {
  ...
  const links = [['About', '/about'], ['Services', '/services'], ['Training', '/training'], ['Projects', '/projects'], ['Downloads', '/downloads'], ['Contact', '/contact']];
  useEffect(() => {
    if (!open) return;
  ...
  return <footer className="site-footer relative isolate overflow-hidden bg-[hsl(var(--primary))] pb-28 pt-16 text-white md:pb-10">
    ...
    <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8">
      <div className="grid gap-12 border-b border-white/15 pb-12 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr]">
        ...
        <FooterList title="Explore" links={[['About', '/about'], ['Services', '/services'], ['Training', '/training'], ['Projects', '/projects'], ['Knowledge', '/knowledge'], ['Downloads', '/downloads']]} />
